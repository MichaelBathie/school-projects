...
;
; This program implements left and right shifts 
;
; Register Dictionary
; R6 - Stack
; R3 - Number to be shifted & result after left shift
; R4 - Number of times to shift & result after right shift
...
;subroutine shiftLeft1 - accepts a 16-bit number and shifts all bits 1 to the left
;Data dictionary
...
;subroutine shiftLeftN - accepts a 16-bit number and a value for the numbers of times to shift it left
;Data dictionary
...
;subroutine shiftRight1 - Takes a 16-bit number and shifts all the bits right once
;Data dictionary
...
shiftRight1
	...
	LD R2, DELETE_WRAP
	AND R1, R1, R2 ;clear the first bit
...
;subroutine shiftRightN - accepts a 16-bit number and a value for the numbers of times to shift it right
;Data dictionary
;R1 - number that needs to be shifted & the result after shifting
;R2 - number of times to shift the number
;R3 - result from the shift
...
DELETE_WRAP .FILL b1111111111111110
